...
class MicrosoftIQConnector:
    ...
    async def query_foundry_iq(self, region: str, query_type: str) -> Dict[str, Any]:
        print(
            f"[MICROSOFT IQ] Querying Foundry IQ for regional context: '{query_type}' in '{region}'..."
        )
        ...
        doc_key = self._match_doc_key(region, query_type)
...
microsoft_iq_connector = MicrosoftIQConnector()
